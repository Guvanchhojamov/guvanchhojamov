...
<br />
<!-- Centered GIF for GitLab profile README -->
<div style="display:flex;justify-content:center;align-items:center;padding:16px;">
  <img
    src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmR2eXltbGU5cmplYWZ1MXFkbnAwc2J5dDJ1dTBxZjA3aDg2eXBuMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/oLzgl79VN6bbrQUSLe/giphy.gif"
    alt="gif"
    loading="lazy"
    style="max-width:320px; width:100%; height:auto; display:block; border-radius:10px; box-shadow: 0 6px 18px rgba(0,0,0,0.12);"
  />
</div>
